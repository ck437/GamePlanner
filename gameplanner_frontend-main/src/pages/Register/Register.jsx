...
function Register() {
  ...
  useEffect(() => {
    firebase.auth().onAuthStateChanged(async (user) => {
      ...
      const response = await axios.post(process.env.URL + '/api/firebase-auth-signup', param);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(process.env.URL + '/api/signup', credentials, { headers: {
